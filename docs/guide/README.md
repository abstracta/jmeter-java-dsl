...
dependencies {
    ...
    testImplementation 'us.abstracta.jmeter:jmeter-java-dsl:0.48'
    components {
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-blazemeter:0.48'
```
:::
::::
...
And the dependency:
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-elasticsearch-listener:0.48'
```
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-dashboard:0.48'
```
:::
::::
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-jdbc:0.48'
```
:::
::::
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-wrapper:0.48'
```
:::
::::
