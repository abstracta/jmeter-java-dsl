...
dependencies {
    ...
    testImplementation 'us.abstracta.jmeter:jmeter-java-dsl:0.57'
    components {
...
::: tab Jbang
```bash
jbang us.abstracta.jmeter:jmeter-java-dsl-jmx2dsl:0.57 test-plan.jmx
```
:::
::::
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-blazemeter:0.57'
```
:::
::::
...
And the dependency:
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-elasticsearch-listener:0.57'
```
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-dashboard:0.57'
```
:::
::::
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-graphql:0.57'
```
:::
::::
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-jdbc:0.57'
```
:::
::::
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-wrapper:0.57'
```
:::
::::
