...
dependencies {
    ...
    testImplementation 'us.abstracta.jmeter:jmeter-java-dsl:1.1'
    components {
...
::: tab Jbang
```bash
jbang us.abstracta.jmeter:jmeter-java-dsl-jmx2dsl:1.1 test-plan.jmx
```
:::
::::
...
//DEPS us.abstracta.jmeter:jmeter-java-dsl:1.1
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-blazemeter:1.1'
```
:::
::::
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-octoperf:1.1'
```
:::
::::
...
And the dependency:
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-elasticsearch-listener:1.1'
```
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-dashboard:1.1'
```
:::
::::
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-graphql:1.1'
```
:::
::::
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-jdbc:1.1'
```
:::
::::
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-wrapper:1.1'
```
:::
::::
