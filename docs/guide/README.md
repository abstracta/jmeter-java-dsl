...
dependencies {
    ...
    testImplementation 'us.abstracta.jmeter:jmeter-java-dsl:0.27'
    components {
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-blazemeter:0.27'
```
:::
::::
...
And the dependency:
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-elasticsearch-listener:0.27'
```
...
::: tab Gradle
```groovy
testImplementation 'us.abstracta.jmeter:jmeter-java-dsl-dashboard:0.27'
```
:::
::::
