  ...
  public class CodeBuilderTest extends MethodCallBuilderTest {
    ...
    public DslTestPlan testPlanWithBasicAuth() {
      return testPlan(
          threadGroup(1, 1,
              httpAuth()
                  // WARNING: including passwords in code repositories may lead to security leaks. Review generated code and consider externalizing any credentials. Eg: System.getenv("AUTH_PASSWORD")
