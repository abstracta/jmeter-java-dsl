...
public class JmeterDsl {
   ...
   * {@link #jsr223PreProcessor(PreProcessorScript)}, same limitations and considerations apply.
   * Check its documentation. To avoid such limitations you may just use
   * {@link #httpSampler(String)} instead, using a JMeter variable and
   ...
   * {@link #jsr223PreProcessor(PreProcessorScript)}, same limitations and considerations apply.
   * Check its documentation To avoid such limitations you may just use
   * {@link #httpSampler(String, String)} instead, using a JMeter variable and
   * {@link #jsr223PreProcessor(String)} to dynamically set the variable.
   *
